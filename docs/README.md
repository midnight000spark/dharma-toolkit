...
| `BFT-v1.12.md` | бизнес-функциональные требования | при работе с требованиями | **hot** (актуальная версия) |
| `BFT-v1.0.md` … `BFT-v1.11.md` | история требований | адресно | reference (read-only) |
