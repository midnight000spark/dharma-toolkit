...
| `BFT-v1.10.md` | бизнес-функциональные требования | при работе с требованиями | **hot** (актуальная версия) |
| `BFT-v1.0.md` … `BFT-v1.9.md` | история требований | адресно | reference (read-only) |
