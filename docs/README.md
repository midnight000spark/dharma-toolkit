...
> _Freshness — owner: пользователь · reviewed: 2026-09-15 · verified-by: `./scripts/check_docs.sh` (PASSED)._
...
| `BFT-v1.11.md` | бизнес-функциональные требования | при работе с требованиями | **hot** (актуальная версия) |
| `BFT-v1.0.md` … `BFT-v1.10.md` | история требований | адресно | reference (read-only) |
