...
/// Расширение скоупа (Этап 8, D-30) = новая строка в [_calendarRegistry]
/// и новый пресет-файл; реализация Бона — тот же вычислительный движок
/// с другими конвенциями и своим паком дней (F-47), отдельный класс-
/// провайдер в этом же реестре.
///
